  ...
  useEffect(() => {
    const processCallback = async () => {
      try {
        ...
        await handleOAuthCallback('google', code, state || undefined);
      ...
      <div className="max-w-md w-full mx-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
          <div className="w-16 h-16 mx-auto mb-4 relative">
            {/* Google Logo with spinning ring */}
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Signing in with Google</h1>
